...
export function LoginForm() {
  ...
  return (
    <Card className="max-w-md mx-auto">
        <CardHeader>
          <CardTitle>{
            (formType === 'login' || formType === 'signup') ? (formType === "login" ? "Welcome Back" : "Create an Account")
            : formType === 'phone' ? 'Sign In with Phone' : 'Enter Verification Code'
          }</CardTitle>
          <CardDescription>
            {formType === 'login' && 'Sign in to access your profile and progress.'}
